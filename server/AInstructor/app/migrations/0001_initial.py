    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profil_picture', models.ImageField(blank=True, max_length=254, null=True, upload_to='', validators=[django.core.validators.validate_image_file_extension])),
                ('is_teacher', models.BooleanField(default='False')),
                ('last_connexion', models.DateField(auto_now=True, null=True)),
                ('jwt', models.CharField(default=0, help_text="dictionnaire de la forme suivante : 'token' : , 'exp'   : ", max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editable_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='editableBy', to=settings.AUTH_USER_MODEL)),
                ('sign_in', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Response',
