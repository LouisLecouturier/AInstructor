...
import purple from '../../../../public/blob/purple.svg'
import yellow from '../../../../public/blob/yellow.svg'
...
export default function Login() {
  ...
  const password = useRef(null)
    ...
    return (
      <>
        <Image priority src={purple} className="fixed -left-1/4 -top-1/4 w-2/3 h-2/3" alt=""/>
        <Image priority src={yellow} className="fixed -right-1/4 -bottom-1/4 w-2/3 h-2/3" alt=""/>
          ...
          <div className="w-2/5 h-4/6 bg-white flex flex-col rounded-lg p-10">
            ...
            <div className="w-full h-full flex flex-col justify-center items-start gap-5">
              ...
              <div className="w-full flex justify-end">
                <a href="#" className="text-accent-500 text-sm font-bold">Forgot password ?</a>
              </div>
            </div>
