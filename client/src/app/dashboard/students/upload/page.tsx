...
export default function Upload() {
  ...
  return (
    <div className="flex-1 h-screen flex flex-col gap-8 px-20 pt-16 pb-32">
      ...
      <h1 className="text-6xl font-black">Import a course</h1>

      <span className="text-lg">
        Donec ultricies mauris a nunc posuere, et sodales sem efficitur. In hac
        habitasse platea dictumst. Vestibulum vulputate quam at dapibus euismod.
        Praesent vulputate lorem vel cursus lacinia.
      </span>

      <div className="flex w-full flex-1 justify-center items-center">
        <div
          className={clsx(
            "flex w-2/3 h-full rounded-3xl border-dashed border-2 border-accent-900 justify-center items-center",
        ...
        >
          <div className="flex flex-col gap-5 items-center">
            ...
            <div className="flex flex-col items-center">
              <span className="text-2xl font-bold">Drop file to upload</span>
