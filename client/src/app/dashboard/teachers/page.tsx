        ...
        {courses.map((course) => (
          ...
          >
            <Button
              ...
              size="sm"
              onClick={() =>
                router.push(`/dashboard/teachers/courses/edit/${course.uuid}`)
              }
            >
              View course
            </Button>
            <Container
              title="Teams"
              className="border-2 border-solid border-accent-100"
              description="all the teams assigned to this course"
            >
