  ...
  return (
    <form className={"flex flex-col gap-4 max-w-[480px]"} onSubmit={onSubmit}>
      ...
      <div className={"flex flex-col gap-2 items-end"}>
        <Input placeholder="Password" name="password" type={"password"} className={clsx(!!session?.user.message ? (session?.user.message == "Authentification successfull" ? "border-green-500 border-2" : "border-secondary-500 border-2") : null)} />
