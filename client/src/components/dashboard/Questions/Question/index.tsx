      ...
      <article className={containerClassNames}>
        ...
        >
          <header>
            ...
            <p className={"font-medium"}>Lorem Ipsum azfkhbqkehfbelqkgfbj</p>
          </header>
        ...
        {props.feedback === "incorrect" && <div className={"flex flex-col gap-1 px-4 pb-4"}>
          <label className={"font-black text-accent-500"}>
            Correction :
          </label>
